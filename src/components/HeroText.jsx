  ...
  return (
    <div className='z-10 mt-20 text-center md:mt-40 md:text-left rounded-3xl bg-clip-text'>
        ...
        <div className='flex-col hidden md:flex c-space'>
            <motion.h1 className='text-4xl font-medium' variants={variants} initial="hidden" animate="visible" transition={{delay: 1}}>Hi, I am Shivam</motion.h1>
        ...
        <div className='flex flex-col space-y-6 md:hidden'>
            <motion.p className='tex-4xl font-medium' variants={variants} initial="hidden" animate="visible" transition={{delay: 1}}>
                Hi, I am Shivam
            </motion.p>
            <div>
